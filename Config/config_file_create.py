...
if __name__ == "__main__":
    # This python file creates a configuration file. Change the below directories for your application
    ...
    config['prepare_dataset'] = {
        ...
        'LIDC_DICOM_PATH': '../Data/CT scans/manifest-1600709154662/LIDC-IDRI',
        ...
        'CLEAN_PATH_IMAGE':'../Data/Clean/Images',
        'CLEAN_PATH_MASK':'../Data/Clean/Masks',
